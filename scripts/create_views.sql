DROP VIEW IF EXISTS  home_select;
CREATE VIEW home_select AS
...
DROP VIEW IF EXISTS  creators;
CREATE VIEW creators AS 
SELECT id, name FROM creator ORDER BY name;

DROP VIEW IF EXISTS  allergens;
CREATE VIEW allergens AS 
...
DROP VIEW IF EXISTS  min_recipe_time;
CREATE VIEW min_recipe_time AS
...
DROP VIEW IF EXISTS  max_recipe_time;
CREATE VIEW max_recipe_time AS
...
DROP VIEW IF EXISTS  single_recipe;
CREATE VIEW single_recipe AS
...
DROP VIEW IF EXISTS  recipe_allergens;
...
DROP VIEW IF EXISTS  recipe_tools;
CREATE VIEW recipe_tools AS
